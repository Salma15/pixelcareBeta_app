...
public class BusinessLists implements Serializable {
    ...
    public BusinessLists(int busid, int vendor_id, String business_name, String address1, String address2, String city_code, String pincode, String lat, String longt, String target_service, String account_type, String phone_no, String photo, String rating, String votes, int category_id, String category_name, List<BusinessSearch> businessNamesArraylist) {
    ...
    public BusinessLists(int busid, int vendor_id, String business_name, String address1, String address2, String city_code, String pincode, String lat, String longt, String target_service, String account_type, String phone_no, String photo, String rating, String votes, int category_id, String category_name, String category_code, String user_location) {
    ...
    public BusinessLists(int busid, int vendor_id, String business_name, String address1, String address2, String city_code, String pincode, String lat, String longt, String target_service, String account_type, String phone_no, String photo, String rating, String votes, int category_id, String category_name, String selected_radius) {
    ...
    public BusinessLists(int businessId, int vendorId, String businessName, String businessAddress1, String businessAddress2,
                         String businessCity, String businessPinCode, String businessTargetService, String businessAccountType,
                         String businessPhoneNo, String businessPhoto, String businessDefaultPhoto, String businessRatings,
                         String businessVotes, int categoryIdId, String businessCategotyName, List<BusinessSearch> businessNamesArraylist) {
        this.business_id = businessId;
        this.vendor_id = vendorId;
        this.business_name = businessName;
        this.address1 = businessAddress1;
        this.address2 = businessAddress2;
        this.city = businessCity;
        this.pincode = businessPinCode;
        this.account_type = businessAccountType;
        this.target_service = target_service;
        this.phone_no = businessPhoneNo;
        this.photo = businessPhoto;
        this.default_photo = default_photo;
        this.category_id = category_id;
        this.category_name = category_name;
        this.radius = businessDefaultPhoto;
        this.ratings = businessCategotyName;
        this.business_array = businessNamesArraylist;
    }
