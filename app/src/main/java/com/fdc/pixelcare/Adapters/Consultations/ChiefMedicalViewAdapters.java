...
public class ChiefMedicalViewAdapters  extends RecyclerView.Adapter<ChiefMedicalViewAdapters.MyViewHolder>  {
    ...
    public ChiefMedicalViewAdapters(Context context, List<ChiefMedicalComplaint> compList) {
