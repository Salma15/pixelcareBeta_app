 ...
 */
public class LoadHospitalsFromUrlTask  extends AsyncTask<Void, Void, String> {

    private Activity activity;
    private String url;
    private ProgressDialog dialog;
    private final static String TAG = LoadHospitalsFromUrlTask.class.getSimpleName();
    ...
    public LoadHospitalsFromUrlTask(HospitalListsActivity hospitalListsActivity, String url, int user_id, int login_member_id,
                                    int selected_city_id, int selected_filter_type, double selected_geo_latitude,
                                    double selected_geo_longitude, int selected_spec_id, int pagination_next) {
        super();
        this.activity = hospitalListsActivity;
        this.url = url;
    ...
    protected void onPostExecute(String result) {
        ((HospitalListsActivity) activity).parseJsonResponse(result);
