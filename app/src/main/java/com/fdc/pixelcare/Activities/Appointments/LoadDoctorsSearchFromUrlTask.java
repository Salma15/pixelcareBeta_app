...
/**
 * Created by salma on 15/03/18.
 */

public class LoadDoctorsSearchFromUrlTask  extends AsyncTask<Void, Void, String> {
    ...
    public LoadDoctorsSearchFromUrlTask(Activity activity, String url, String doc_filtertype, int SpecID, String HospID, int pagination_val) {
        super();
    ...
    protected void onPostExecute(String result) {
        ((DoctorSearchActivity) activity).parseJsonResponse(result);
    ...
    private class JSONParser {
        ...
        public JSONObject getJSONFromUrl(String url) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair(APIParam.KEY_SEARCH, String.valueOf(DOCTOR_CITY)));
