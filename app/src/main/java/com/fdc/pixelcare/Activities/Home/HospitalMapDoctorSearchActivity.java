 ...
 */
public class HospitalMapDoctorSearchActivity extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shareadPreferenceClass = new ShareadPreferenceClass(HospitalMapDoctorSearchActivity.this);
        sharedPreferences = shareadPreferenceClass.getSharedPreferences(HospitalMapDoctorSearchActivity.this);
        ...
        if (sharedPreferences != null) {
            ...
            Log.d(AppUtils.TAG, " *********** HospitalMapDoctorSearchActivity **************** ");
    ...
    private void initializationViews(Bundle savedInstanceState) {
        ...
        adapter = new ConsultedDoctorsAdapter(HospitalMapDoctorSearchActivity.this,doctorListArraylist);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(HospitalMapDoctorSearchActivity.this);
        ...
        final DoctorsSeachMapAdapter adapter = new DoctorsSeachMapAdapter(HospitalMapDoctorSearchActivity.this, R.layout.activity_search_map_item, R.id.lbl_name, doctorListArraylist);
    ...
    private void collectDoctorsSearchResultFromServer(final String SEARCH_QUERY) {
        ...
        Log.i(AppUtils.TAG, " SEARCH_QUERY " + SEARCH_QUERY);
        ...
        final ProgressDialog progressDialog = new ProgressDialog(HospitalMapDoctorSearchActivity.this, ProgressDialog.THEME_HOLO_LIGHT);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, APIClass.DRS_HOST_DOC_MAP_SEARCH,
        ...
        RequestQueue requestQueue = AppController.getInstance(HospitalMapDoctorSearchActivity.this).
                getRequestQueue();
        AppController.getInstance(HospitalMapDoctorSearchActivity.this).addToRequestQueue(stringRequest);
    }

    private void refreshRecyclerViews(List<DoctorList> doctorsListArraylist) {

        adapter = new ConsultedDoctorsAdapter(HospitalMapDoctorSearchActivity.this, doctorsListArraylist);
        recyclerView_doctorlist.setAdapter(adapter);
        adapter.notifyDataSetChanged();
    }
