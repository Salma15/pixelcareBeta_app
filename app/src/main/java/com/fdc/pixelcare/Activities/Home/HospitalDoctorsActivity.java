...
/**
 * Created by SALMA on 01-11-2018.
 */
public class HospitalDoctorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shareadPreferenceClass = new ShareadPreferenceClass(HospitalDoctorsActivity.this);
        sharedPreferences = shareadPreferenceClass.getSharedPreferences(HospitalDoctorsActivity.this);
        ...
        if (sharedPreferences != null) {
            ...
            Log.d(AppUtils.TAG, " *********** HospitalDoctorsActivity **************** ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.action_search:
                ...
                Intent i2 = new Intent(HospitalDoctorsActivity.this, HospitalDoctorSearchActivity.class);
    ...
    private void initializationViews(Bundle savedInstanceState) {
        ...
        url_page1 = APIClass.DRS_HOST_HOSPITALS_DOCTORS_LIST;
        ...
        if (NetworkUtil.getConnectivityStatusString(HospitalDoctorsActivity.this).equalsIgnoreCase("enabled")) {
            collectHospitalsListsDetails();
        } else {
            AppUtils.showCustomAlertMessage(HospitalDoctorsActivity.this, MHConstants.INTERNET,MHConstants.INTERNET_CHECK, "OK", null, null);
        }
    ...
    private void getDataFromUrl(String url) {
        ...
        new LoadDoctorsFromUrlTask(this, url, USER_ID, LOGIN_MEMBER_ID, SELECTED_CITY_ID, SELECTED_FILTER_TYPE, SELECTED_GEO_LATITUDE, SELECTED_GEO_LONGITUDE, SELECTED_SPEC_ID, PAGINATION_NEXT, HOSPITAL_ID).execute();
    }
    ...
    private void collectSpecializationDetails() {
        final ProgressDialog progressDialog1 = new ProgressDialog(HospitalDoctorsActivity.this, ProgressDialog.THEME_HOLO_LIGHT);
        ...
        RequestQueue requestQueue = AppController.getInstance(HospitalDoctorsActivity.this).
                getRequestQueue();
        AppController.getInstance(HospitalDoctorsActivity.this).addToRequestQueue(stringRequest);
    }
    ...
    private void collectCitiesDetails() {
        ...
        stringRequest.setRetryPolicy(policy);
        RequestQueue requestQueue = AppController.getInstance(HospitalDoctorsActivity.this).getRequestQueue();
        AppController.getInstance(HospitalDoctorsActivity.this).addToRequestQueue(stringRequest);
    }
    ...
    private void ChooseFilterCustomDialog(List<CitiesList> citiesArraylist, List<SpecializationList> specializationListArraylist) {
        ...
        final Dialog dialog = new Dialog(HospitalDoctorsActivity.this, R.style.CustomDialog);
        ...
        SpinnerDialog spinnerDialog = new SpinnerDialog(HospitalDoctorsActivity.this,city_names,"Select or Search City","Close Button Text");// With No Animation
        spinnerDialog = new SpinnerDialog(HospitalDoctorsActivity.this,city_names,"Select or Search City",R.style.DialogAnimations_SmileWindow,"CLOSE");// With  Animation
        ...
        SpinnerDialog spinnerDialog1 = new SpinnerDialog(HospitalDoctorsActivity.this,spec_names,"Select or Search Specialty","Close Button Text");// With No Animation
        spinnerDialog1 = new SpinnerDialog(HospitalDoctorsActivity.this,spec_names,"Select or Search Specialty",R.style.DialogAnimations_SmileWindow,"CLOSE");// With  Animation
