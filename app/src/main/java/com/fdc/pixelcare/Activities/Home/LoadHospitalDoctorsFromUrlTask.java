 ...
 */
public class LoadHospitalDoctorsFromUrlTask extends AsyncTask<Void, Void, String> {
    ...
    public LoadHospitalDoctorsFromUrlTask(HospitalMapDoctorsActivity doclListsActivity, String url, int user_id, int login_member_id,
    ...
    protected void onPostExecute(String result) {
        ((HospitalMapDoctorsActivity) activity).parseJsonResponse(result);
